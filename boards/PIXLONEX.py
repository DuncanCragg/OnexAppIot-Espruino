...
#     'DEFINES+=-DCONFIG_GPIO_AS_PINRESET', # Allow the reset pin to work
     ...
     'INCLUDE += -I$(ROOT)/OnexKernel/include -I$(ROOT)/OnexKernel/src/onp -I$(ROOT)/OnexLang/include',
...
chip = {
  ...
  'dac' : 0,
  'saved_code' : {
    'address' : ((118 - 9 + 2) * 4096), # Bootloader takes pages 120-127, FS takes 118-119
    'page_size' : 4096,
    'pages' : 9,
